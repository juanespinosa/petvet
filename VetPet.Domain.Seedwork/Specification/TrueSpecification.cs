namespace VetPet.Domain.Seedwork.Specification
{
        ...
        where TEntity:class
    {
        ...
        /// <summary>
        /// <see cref=" VetPet.Domain.Seedwork.Specification.Specification{TEntity}"/>
        /// </summary>
        /// <returns><see cref=" VetPet.Domain.Seedwork.Specification.Specification{TEntity}"/></returns>
